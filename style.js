...
function getAkanName () {
  ...
  let femaleAkanNames = [
    "Akosua", "Adwoa", "Abenaa", "Akua", "Yaa", "Afua", "Ama"
      ...
      //Statement That VAlidates The users input
  if (myGenderValue == "male" & monthValid & dayValid){
    switch (dayOfWeekNumber) {
      ...
      case 4:
        ...
        break;
      case 5:
        document.getElementById('result').textCont
  let myGenderValue = getGender();
  ...
  if (myGenderValue == "male" & monthValid & dayValid){
    ...
    switch (dayOfWeekNumber) {
      ...
      case 0:
        document.getElementById('result').textContent = "You were born on a Sunday: your Akan name is " + femaleAkanNames[0];
        document.getElementById('display-name').textContent = "Here's your Akan name: ";
        return false;
        break;
